    ...
    <div style="margin: 0 auto; 
        ...
        <div >
            ...
            <p style="font-family: Poppins;
                    ...
                    width: 500px;
                    margin-bottom: 24px;
                    ">You've been assigned a new task as detailed below, <b>created by Jeet.</b>
            </p>
            ...
            <table style="border-radius: 10px;
                ...
                <tbody>
                    <tr style=" border: 1px solid #DDD;">
                        ...
                        <td style=" border: 1px solid #DDD;padding: 10px 0 8px 21px;">gold man</td>
                    </tr>
                    
                    <tr>
                        <td style=" border: 1px solid #DDD;padding:9px 0 8px 21px;">Assigned To</td>
                        <td style=" border: 1px solid #DDD;padding: 9px 0 8px 21px;">jeet</td>
                    </tr>
                    <tr>
                        <td style=" border: 1px solid #DDD;padding:9px 0 8px 21px;">Priority</td>
                        <td style=" border: 1px solid #DDD;padding: 9px 0 8px 21px;">low</td>
                    </tr>
                </tbody>
                <tfoot>
                    <tr>
