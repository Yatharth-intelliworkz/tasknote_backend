                    ...
                    <div class="card">
                        @can('task-create')
                            <div class="card-header">
                                <a class="btn btn-primary float-right" href="{{ route('task.create') }}"><i class="fa fa-plus" aria-hidden="true"></i> Create New Task</a>
                            </div>
                        @endcan    
                                    ...
                                    @foreach ($task as $val)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @can('task-edit')
                                                    <a class="btn btn-primary btn-rounded btn-icon" href="{{ route('task.edit',$val->id) }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                @endcan
                                                @can('task-delete')
                                                {{-- <a class="btn btn-danger btn-rounded btn-icon" href="{{ route('roles.destroy'.$val->id) }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a> --}}
                                                    {!! Form::open(['method' => 'DELETE','route' => ['task.destroy', $val->id],'style'=>'display:inline']) !!}
