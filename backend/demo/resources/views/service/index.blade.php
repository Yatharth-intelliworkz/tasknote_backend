                    ...
                    <div class="card">
                        @can('service-create')
                            <div class="card-header">
                                <a class="btn btn-primary float-right" href="{{ route('service.create') }}"><i class="fa fa-plus" aria-hidden="true"></i> Create New Service</a>
                            </div>
                        @endcan
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($service as $val)
                                        ...
                                        <td>
                                            ...
                                            @can('service-edit')
                                                <a class="btn btn-primary btn-rounded btn-icon" href="{{ route('service.edit',$val->id) }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                            @endcan
                                            @can('service-delete')
                                            {{-- <a class="btn btn-danger btn-rounded btn-icon" href="{{ route('roles.destroy'.$val->id) }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a> --}}
                                                {!! Form::open(['method' => 'DELETE','route' => ['service.destroy', $val->id],'style'=>'display:inline']) !!}
